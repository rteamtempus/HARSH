...
### 4.5 Daily / Weekly / Monthly Briefing  *[v1 landed: schema + generator + portal view + display panel; needs scheduler + TTS audio caching + event-triggered regen]*
...
### 4.6 Weekly Planning Meeting — AI Scribe  *[v1 landed: capture + transcribe + extract + review/commit; 24h forgotten-review reminder + briefing surfacing + speaker assignment polish pending]*
